...
const genAI = new GoogleGenerativeAI("AIzaSyBrmDL_aTUD9mYweK1wehLyJ6wx8sbB0aQ");
...
async function chat(message) {
  // const chat = model.startChat(chatId);
...
// Write a function to give words to practice the wrong sound
